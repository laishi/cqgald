		...
		$(function() {
		    ...
		    rotateSlider.slideCount = $('.rotate-slider .cicleSlides li').length;
		    rotateSlider.slideAngle = 360 / $('.rotate-slider .cicleSlides li').length;
		    rotateSlider.sliderElement = $('.rotate-slider');
		    rotateSlider.slides = $('.rotate-slider .cicleSlides li');
		    rotateSlider.slidesContainer = $('.rotate-slider .cicleSlides');
